...
namespace niedoida {
    ...
    namespace core {
        ...
        CombinedJKMatrixCoreGradientGenerator::
            CombinedJKMatrixCoreGradientGenerator(
        ...
        double CombinedJKMatrixCoreGradientGenerator::max_P2(
        ...
        void CombinedJKMatrixCoreGradientGenerator::calc_matrix_core_gradient(
        ...
        void CombinedJKMatrixCoreGradientGenerator::set_max_P_shells(
