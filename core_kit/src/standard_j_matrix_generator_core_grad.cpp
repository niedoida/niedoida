...
namespace niedoida {
    ...
    namespace core {
        ...
        StandardJMatrixCoreGradientGenerator::
            StandardJMatrixCoreGradientGenerator(
        ...
        double StandardJMatrixCoreGradientGenerator::max_P2(
        ...
        void StandardJMatrixCoreGradientGenerator::calc_matrix_core_gradient(
        ...
        void StandardJMatrixCoreGradientGenerator::set_max_P_shells(
