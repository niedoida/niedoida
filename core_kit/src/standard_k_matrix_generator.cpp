...
namespace niedoida {
    ...
    namespace core {
        ...
        StandardKMatrixGenerator::StandardKMatrixGenerator(
        ...
        void StandardKMatrixGenerator::set_density_matrix(
            const arma::mat& P_alpha, const arma::mat& P_beta, bool incremental)
        {
            niedoida::io::Log::Section section("forming J");
        ...
        void StandardKMatrixGenerator::set_max_P_shells(
        ...
        void StandardKMatrixGenerator::update(bool incremental, bool polarized)
        {
            {
            ...
            arma::mat partial = m_K[SPIN_ALPHA];
            for (std::size_t i = 0;
                 i < niedoida::misc::GlobalThreadPool::no_threads();
                 ++i)
        ...
        StandardKMatrixGenerator::WorkHorse::WorkHorse(
            std::shared_ptr<const System> system,
        ...
        void StandardKMatrixGenerator::WorkHorse::reset(bool incremental,
                                                        bool polarized)
        {
        ...
        void StandardKMatrixGenerator::WorkHorse::run()
        {
            update_task(m_incremental ? m_delta_P : m_P);
        }

        double StandardKMatrixGenerator::WorkHorse::max_P(
        ...
        void StandardKMatrixGenerator::WorkHorse::update_task(
            const arma::mat* const P)
        {
            for (;;) {
                // pile up requests
        ...
        void StandardKMatrixGenerator::WorkHorse::partial_update_polarized(
        ...
        void StandardKMatrixGenerator::WorkHorse::partial_update_unpolarized(
