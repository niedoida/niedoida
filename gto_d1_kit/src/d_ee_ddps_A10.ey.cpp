...
void two_electrons_gradient_ddps_A(const unsigned Al,
                                   const unsigned Bl,
                                   const unsigned Cl,
                                   const unsigned Dl,
                                   const double ae,
                                   ...
                                   double* const gz)
{
    ...
    if (Bl == 1 && Cl == 0) {
        two_electrons_gradient_ddps_A(Al,
                                      Bl,
                                      Dl,
                                      Cl,
                                      ae,
    ...
    if (Al == 1 && Dl == 0) {
        two_electrons_gradient_ddps_B(Bl,
                                      Al,
                                      Cl,
                                      Dl,
                                      be,
