...
void two_electrons_gradient_ddps_D(const unsigned Al,
                                   const unsigned Bl,
                                   const unsigned Cl,
                                   const unsigned Dl,
                                   const double ae,
                                   ...
                                   double* const gz)
{
    ...
    if (Bl == 1 && Cl == 0) {
        two_electrons_gradient_ddps_C(Al,
                                      Bl,
                                      Dl,
                                      Cl,
                                      ae,
    ...
    if (Bl == 0 && Dl == 1) {
        two_electrons_gradient_ddps_B(Cl,
                                      Dl,
                                      Al,
                                      Bl,
                                      ce,
    ...
    if (Bl == 0 && Cl == 1) {
        two_electrons_gradient_ddps_A(Dl,
                                      Cl,
                                      Al,
                                      Bl,
                                      de,
