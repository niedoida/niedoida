...
void two_electrons_gradient_dpps_B(const unsigned Al,
                                   const unsigned Bl,
                                   const unsigned Cl,
                                   const unsigned Dl,
                                   const double ae,
                                   ...
                                   double* const gz)
{
    ...
    if (Al == 2 && Cl == 0) {
        two_electrons_gradient_dpps_B(Al,
                                      Bl,
                                      Dl,
                                      Cl,
                                      ae,
    ...
    if (Bl == 2 && Dl == 0) {
        two_electrons_gradient_dpps_A(Bl,
                                      Al,
                                      Cl,
                                      Dl,
                                      be,
