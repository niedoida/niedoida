...
void two_electrons_gradient_dpps_C(const unsigned Al,
                                   const unsigned Bl,
                                   const unsigned Cl,
                                   const unsigned Dl,
                                   const double ae,
                                   ...
                                   double* const gz)
{
    ...
    if (Al == 2 && Cl == 0) {
        two_electrons_gradient_dpps_D(Al,
                                      Bl,
                                      Dl,
                                      Cl,
                                      ae,
    ...
    if (Bl == 0 && Cl == 2) {
        two_electrons_gradient_dpps_A(Cl,
                                      Dl,
                                      Al,
                                      Bl,
                                      ce,
    ...
    if (Bl == 0 && Dl == 2) {
        two_electrons_gradient_dpps_B(Dl,
                                      Cl,
                                      Al,
                                      Bl,
                                      de,
