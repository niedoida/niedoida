...
void eri_gradient_2010_1_et(const double ae,
                            const double xA,
                            const double yA,
                            const double zA,
                            const double be,
                            ...
                            double* const etz)
{
    ...
    const double C60 = -(C184 * be + C738 * C1012 + C1035) / q;
    const double C81 = -(C232 * be + C784 * C1012 + C1037) / q;
    const double C102 =
        C862 / q - (C280 * be + C831 * C1012) / q - (C863 * p) / q;
    const double C123 = -(C328 * be + C878 * C1012 + C1042) / q;
    const double C144 = C1041 - (C373 * be + C922 * C1012) / q - C1038 / q;
    const double C165 = C1040 - (C417 * be + C965 * C1012) / q - C1039 / q;
    ...
    const double C51 = -(C184 * be + C466 * C1011 + C1020) / q;
    const double C72 =
        C528 / q - (C232 * be + C512 * C1011) / q - (C529 * p) / q;
    const double C93 = -(C280 * be + C559 * C1011 + C1025) / q;
    const double C114 = C1027 - (C328 * be + C606 * C1011) / q - C1022 / q;
    const double C135 = -(C373 * be + C650 * C1011 + C1028) / q;
    const double C156 = C1029 - (C417 * be + C693 * C1011) / q - C1023 / q;
    ...
    const double C40 =
        C188 / q - (C184 * be + C189 * C1010) / q - (C190 * p) / q;
    const double C63 = -(C232 * be + C236 * C1010 + C1004) / q;
    const double C84 = -(C280 * be + C284 * C1010 + C1006) / q;
    const double C105 = C1013 - (C328 * be + C332 * C1010) / q - C1000 / q;
    const double C126 = C1015 - (C373 * be + C377 * C1010) / q - C1003 / q;
    const double C147 = -(C417 * be + C421 * C1010 + C1009) / q;
