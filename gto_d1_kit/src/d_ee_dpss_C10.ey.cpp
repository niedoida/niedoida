...
void two_electrons_gradient_dpss_C(const unsigned Al,
                                   const unsigned Bl,
                                   const unsigned Cl,
                                   const unsigned Dl,
                                   const double ae,
                                   ...
                                   double* const gz)
{
    ...
    if (Al == 2 && Dl == 1) {
        two_electrons_gradient_dpss_D(Al,
                                      Bl,
                                      Dl,
                                      Cl,
                                      ae,
    ...
    if (Al == 1 && Cl == 2) {
        two_electrons_gradient_dpss_A(Cl,
                                      Dl,
                                      Al,
                                      Bl,
                                      ce,
    ...
    if (Al == 1 && Dl == 2) {
        two_electrons_gradient_dpss_B(Dl,
                                      Cl,
                                      Al,
                                      Bl,
                                      de,
