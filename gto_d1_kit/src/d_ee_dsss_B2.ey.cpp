...
void eri_gradient_2000_2_et(const double ae,
                            const double xA,
                            const double yA,
                            const double zA,
                            const double be,
                            ...
                            double* const etz)
{
    ...
    const double C63 = vrx[3];
    const double C70 = vrx[4];
    const double C77 = vrx[5];
    const double C44 = vry[0];
    const double C51 = vry[1];
    const double C58 = vry[2];
    const double C65 = vry[3];
    const double C72 = vry[4];
    const double C79 = vry[5];
    const double C46 = vrz[0];
    const double C53 = vrz[1];
    const double C60 = vrz[2];
    const double C67 = vrz[3];
    const double C74 = vrz[4];
    const double C81 = vrz[5];
    etx[0] = C40;
    etx[1] = C49;
    etx[2] = C56;
    etx[3] = C63;
