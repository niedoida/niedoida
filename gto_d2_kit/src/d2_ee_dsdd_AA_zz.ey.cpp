...
#include "gto_d2_kit/d2_ee_dsdd_AA_zz.hpp"
#include <cmath>
/*
...
void second_derivative_ee_2022_11_33(const double ae,
                                     const double xA,
                                     const double yA,
                                     const double zA,
                                     const double be,
                                     ...
                                     double* const d2ee)
{
    ...
    const double C29976 = 2 * C29968;
    const double C29975 = std::pow(C29968, 2);
    const double C29978 = 2 * C29967;
    const double C29977 = C29967 * C29966;
    const double C31147 = std::pow(C29966, 2);
    const double C31213 = C29966 * be;
    ...
    const double C31212 = C31133 * be;
    const double C31181 = std::pow(C29976, -2);
    const double C31180 = std::pow(C29976, -1);
    ...
    const double C31189 = std::pow(C30921, -2);
    const double C30935 = 2 * C30920;
    const double C31193 = C30920 * C30921;
    const double C31192 = 4 * C30920;
    const double C31182 = std::pow(C30919, 2);
    const double C30923 = C30918 * C30916;
    const double C30951 = C30950 * C30916;
    const double C31194 = std::pow(C31007, 2);
    const double C30969 = C30968 * C30916;
    const double C31196 = std::pow(C31049, 2);
    ...
    const double C31224 = 4 * C31193;
    const double C31223 = C30917 * C31192;
    ...
    const double C29979 = C29977 * C31151;
    const double C113 =
        -((C31151 - (C29966 * 2 * C29967 * C29966 * C31151) / C29968) * 2 *
          C29967) /
        C29968;
    const double C114 = -(2 * C29967 * C29966 * C31151) / C29968;
    const double C31245 = C31151 * C31213;
    const double C8982 =
        (C31151 * std::pow(C31213, 2)) / C29975 + C31151 / C29976;
    const double C8984 = C31181 * C31151;
    const double C18734 = C31180 * C31151;
    ...
    const double C103 =
        (C30904 * std::pow(C31179, 2)) / C29975 + C30904 / C29976;
    const double C105 = C31181 * C30904;
    const double C13238 = C31180 * C30904;
    const double C30928 = C30926 * C30919;
    const double C30927 = C30926 / C30921;
    const double C30937 = C30934 * C30926;
    const double C31185 = C30926 * C30922;
    const double C31221 = C31189 * C30926;
    const double C31215 = C30926 * C31182;
    const double C31008 = C30954 / C30921;
    const double C31010 = C30954 * C31007;
    const double C31017 = C30934 * C30954;
    const double C31200 = C30954 * C31009;
    const double C31227 = C31189 * C30954;
    const double C31225 = C30954 * C31194;
    const double C31050 = C30972 / C30921;
    const double C31052 = C30972 * C31049;
    const double C31059 = C30934 * C30972;
    const double C31206 = C30972 * C31051;
    const double C31230 = C31189 * C30972;
    const double C31228 = C30972 * C31196;
    const double C31244 = C31138 * C31212;
    const double C4733 =
        (C31138 * std::pow(C31212, 2)) / C29975 + C31138 / C29976;
    const double C4735 = C31181 * C31138;
    const double C13236 = C31180 * C31138;
    const double C29980 = 2 * C29979;
    ...
    const double C8983 = (-2 * C31180 * C31245) / C29968;
    const double C18733 = -C31245 / C29968;
    ...
    const double C104 = (-2 * C31180 * C31214) / C29968;
    const double C13237 = -C31214 / C29968;
    const double C30929 = C30928 * C30922;
    const double C30936 = C30928 / C30935;
    const double C31186 = C30934 * C30928;
    const double C31184 = C30928 / C30917;
    const double C286 = (C30926 * std::pow(C30922, 2)) / C30920 + C30927;
    const double C30938 = C30937 * C30922;
    const double C31190 = C30919 * C30937;
    const double C31188 = 2 * C30937;
    const double C31231 = C30937 / C31192;
    const double C112 = C30937 / C31224;
    const double C2881 = C30937 / C30921;
    const double C31217 = C31185 / C30917;
    const double C287 = (-2 * C30934 * C31185) / C30917;
    const double C31246 = C31215 / C30920;
    ...
    const double C31198 = C31010 / C30917;
    const double C31195 = C30934 * C31010;
    const double C31018 = C31017 * C31009;
    const double C31204 = C31007 * C31017;
    const double C31203 = 2 * C31017;
    const double C31237 = C31017 / C31192;
    const double C1144 = C31017 / C31224;
    const double C2878 = C31017 / C30921;
    const double C31233 = C31200 / C30917;
    const double C1073 = (-2 * C30934 * C31200) / C30917;
    const double C31251 = C31225 / C30920;
    ...
    const double C31199 = C31052 / C30917;
    const double C31197 = C30934 * C31052;
    const double C31060 = C31059 * C31051;
    const double C31210 = C31049 * C31059;
    const double C31209 = 2 * C31059;
    const double C31243 = C31059 / C31192;
    const double C1997 = C31059 / C31224;
    const double C3780 = C31059 / C30921;
    const double C31239 = C31206 / C30917;
    const double C1819 = (-2 * C30934 * C31206) / C30917;
    const double C31253 = C31228 / C30920;
    const double C4734 = (-2 * C31180 * C31244) / C29968;
    const double C13235 = -C31244 / C29968;
    const double C29981 = C29966 * C29980;
    const double C8990 =
        ((-C29980 / C29968) / C29976 - (0 * be) / C29968) / C29976 -
        (0 * be) / C29968;
    const double C18738 = (-C29980 / C29968) / C29976 - (0 * be) / C29968;
    ...
    const double C31218 = 2 * C31186;
    const double C30939 = C30938 / C30917;
    const double C31222 = C31190 / C30935;
    const double C31247 = C31184 - C31217;
    const double C2618 = -C31217;
    const double C31261 = C31246 + C30927;
    const double C31012 = C31011 / C30920;
    const double C31226 = 2 * C31195;
    const double C31019 = C31018 / C30917;
    const double C31236 = C31204 / C30935;
    const double C31255 = C31198 - C31233;
    const double C2510 = -C31233;
    const double C31264 = C31251 + C31008;
    const double C31054 = C31053 / C30920;
    const double C31229 = 2 * C31197;
    const double C31061 = C31060 / C30917;
    const double C31242 = C31210 / C30935;
    const double C31258 = C31199 - C31239;
    const double C3272 = -C31239;
    const double C31265 = C31253 + C31050;
    ...
    const double C31248 = C31218 / C30917;
    const double C30940 = C30936 - C30939;
    const double C31262 = C31247 / C30921;
    const double C31013 = C31008 - C31012;
    const double C31252 = C31226 / C30917;
    const double C31020 = C31016 - C31019;
    const double C31266 = C31255 / C30921;
    const double C31055 = C31050 - C31054;
    const double C31254 = C31229 / C30917;
    const double C31062 = C31058 - C31061;
    const double C31268 = C31258 / C30921;
    ...
    const double C31183 = C30931 * C30919;
    const double C31220 = C31188 + C30931;
    const double C31191 = C30940 / C30921;
    const double C31187 = C30940 * C30919;
    const double C654 = C31262 - (C30931 * C30922) / C30917;
    const double C31201 = C31013 * C31007;
    const double C31235 = C31203 + C31013;
    const double C31205 = C31020 / C30921;
    const double C31202 = C31020 * C31007;
    const double C1414 = C31266 - (C31013 * C31009) / C30917;
    const double C31207 = C31055 * C31049;
    const double C31241 = C31209 + C31055;
    const double C31211 = C31062 / C30921;
    const double C31208 = C31062 * C31049;
    const double C2282 = C31268 - (C31055 * C31051) / C30917;
    const double C29984 = C29983 * C29978;
    const double C8986 =
        ((-(0 * be) / C29968) / C29976 -
         ((0 - (C29966 * C29974) / C29968) * be) / C29968) /
            C29976 -
        ((C29966 * ((-C29974 / C29968) / C29976 - (C29983 * be) / C29968) +
          C18733) *
         be) /
            C29968 +
        (-C29980 / C29968) / C29976 - (0 * be) / C29968;
    const double C8988 =
        ((-C29974 / C29968) / C29976 - (C29983 * be) / C29968) / C29976 -
        ((C29966 * ((-C29980 / C29968) / C29976 - (0 * be) / C29968) + C18734) *
         be) /
            C29968;
    const double C18736 = (-C29974 / C29968) / C29976 - (C29983 * be) / C29968;
    ...
    const double C31216 = C31183 / C30917;
    const double C31249 = C31220 / C30921;
    const double C31250 = C31222 + C31191;
    const double C656 = C31191 - C30938 / C30935;
    const double C31219 = C31187 / C30917;
    const double C31232 = C31201 / C30917;
    const double C31256 = C31235 / C30921;
    const double C31257 = C31236 + C31205;
    const double C1416 = C31205 - C31018 / C30935;
    const double C31234 = C31202 / C30917;
    const double C31238 = C31207 / C30917;
    const double C31259 = C31241 / C30921;
    const double C31260 = C31242 + C31211;
    const double C2284 = C31211 - C31060 / C30935;
    const double C31240 = C31208 / C30917;
    const double C29992 = C29966 * C29984;
    const double C8985 =
        (-(be * -2 * C29974) / C29975) / C29976 -
        ((2 * ((-C29974 / C29968) / C29976 - (C29983 * be) / C29968) -
          (C29966 * ((-4 * C29979) / C29968 - (C29966 * C29984) / C29968) *
           be) /
              C29968) *
         be) /
            C29968 -
    ...
    const double C18737 = (-C29984 / C29968) / C29976;
    ...
    const double C31270 = C31216 + C31262;
    const double C655 = C31249 - (C30940 * C30922) / C30917;
    const double C111 = C31250 / C30921 - C30938 / C31223;
    const double C31263 = C31219 + C31249;
    const double C31271 = C31232 + C31266;
    const double C1415 = C31256 - (C31020 * C31009) / C30917;
    const double C1143 = C31257 / C30921 - C31018 / C31223;
    const double C31267 = C31234 + C31256;
    const double C31272 = C31238 + C31268;
    const double C2283 = C31259 - (C31062 * C31051) / C30917;
    const double C1996 = C31260 / C30921 - C31060 / C31223;
    const double C31269 = C31240 + C31259;
    const double C8987 =
        (-(((-4 * C29979) / C29968 - C29992 / C29968) * be) / C29968) / C29976 -
        ((2 * ((-C29980 / C29968) / C29976 - (0 * be) / C29968) -
          C29992 / (2 * C29975)) *
         be) /
            C29968;
    const double C18735 =
        -(((-4 * C29979) / C29968 - C29992 / C29968) * be) / C29968;
    ...
    const double C108 =
        (C31261 + 2 * C30931) / C30921 - (C31270 * C30922) / C30917;
    const double C109 =
        (C31248 + 2 * C30940 + C31270) / C30921 - (C31263 * C30922) / C30917;
    const double C110 = (C31221 + C30937 / C30917 + C31263) / C30921 -
                        (C31250 * C30922) / C30917;
    const double C1140 =
        (C31264 + 2 * C31013) / C30921 - (C31271 * C31009) / C30917;
    const double C1141 =
        (C31252 + 2 * C31020 + C31271) / C30921 - (C31267 * C31009) / C30917;
    const double C1142 = (C31227 + C31017 / C30917 + C31267) / C30921 -
                         (C31257 * C31009) / C30917;
    const double C1993 =
        (C31265 + 2 * C31055) / C30921 - (C31272 * C31051) / C30917;
    const double C1994 =
        (C31254 + 2 * C31062 + C31272) / C30921 - (C31269 * C31051) / C30917;
    const double C1995 = (C31230 + C31059 / C30917 + C31269) / C30921 -
                         (C31260 * C31051) / C30917;
         ...
         ((((((C113 * C115 + C137 + C137 + C31151 * C129) * C13235 +
          ...
          ((((C13549 + C13548) * C13237 + (C13552 + C13553) * C13238) * C31059 -
            ((C13242 + C13243) * C13238 + (C13241 + C13240) * C13237) *
                C31199) *
               C31013 +
           (((C13395 + C13394) * C13237 + (C13398 + C13399) * C13238) * C31199 -
           ...
           (((C5324 * C13235 + C5323 * C13236) * C13237 +
            ...
            ((C15419 + C15420) * C13238 +
             (C5654 * C13236 + C5653 * C13235) * C13237) *
               ...
               C31017) *
              C2618 +
          ((((C13549 + C13548) * C13237 + (C13552 + C13553) * C13238) * C31254 -
            ((C13242 + C13243) * C13238 + (C13241 + C13240) * C13237) * C31265 -
            ((C13554 + C13555) * C13238 + (C13551 + C13550) * C13237) *
                C31230) *
               C2510 +
           (((C13395 + C13394) * C13237 + (C13398 + C13399) * C13238) * C31265 -
            ((C14016 + C14017) * C13238 + (C14015 + C14014) * C13237) * C31254 +
          ...
          ((((C13549 + C13548) * C13237 + (C13552 + C13553) * C13238) * C31059 -
           ...
           (((C13395 + C13394) * C13237 + (C13398 + C13399) * C13238) * C31199 -
            ((C14016 + C14017) * C13238 + (C14015 + C14014) * C13237) *
               ...
               C31017) *
              C30940 +
          ((((C13243 + C13242) * C13237 + (C13244 + C13245) * C13238) * C31199 -
    ...
    d2ee[12] +=
        ...
        (std::sqrt(0.75) * 2 * std::pow(Pi, 2.5) *
         (((((C113 * C115 + C137 + C137 + C31151 * C129) * C13235 +
          ...
          (((C13549 + C13548) * C13237 + (C13552 + C13553) * C13238) * C31254 -
           ((C13242 + C13243) * C13238 + (C13241 + C13240) * C13237) * C31265 -
           ((C13554 + C13555) * C13238 + (C13551 + C13550) * C13237) * C31230) *
              C30954 * C287 +
          (((C13243 + C13242) * C13237 + (C13244 + C13245) * C13238) * C31265 -
           ...
           ((C13548 + C13549) * C13238 +
            (C5324 * C13236 +
             (C113 * C480 + C515 + C515 + C31151 * C500) * C13235) *
              ...
              C30954 * C654 +
          (((C13549 + C13548) * C13237 + (C13552 + C13553) * C13238) * C31059 -
           ((C13242 + C13243) * C13238 + (C13241 + C13240) * C13237) * C31199) *
              C30954 * C655 +
          (((C13243 + C13242) * C13237 + (C13244 + C13245) * C13238) * C31199 -
          ...
          (((C13819 + C13818) * C13237 +
            (C777 * C13235 +
             (C113 * C928 + C950 + C950 + C31151 * C938) * C13236) *
                C13238) *
               C31059 -
           ((C13246 + C13247) * C13238 + (C13245 + C13244) * C13237) * C31199) *
              C30954 * C31231)) /
            (p * q * std::sqrt(p + q)) +
        (std::sqrt(9.) * 2 * std::pow(Pi, 2.5) *
         (((((C113 * C115 + C137 + C137 + C31151 * C129) * C13235 +
           ...
           ((C15557 + C15553) * C13238 +
            (C6688 * C13236 +
             (C113 * C2000 + C2019 + C2019 + C31151 * C2012) * C13235) *
               ...
               C31243) *
              C30954 * C2618 +
          (((C13549 + C13548) * C13237 + (C13552 + C13553) * C13238) * C31269 -
           ((C13242 + C13243) * C13238 + (C13241 + C13240) * C13237) * C31272 -
           ((C13554 + C13555) * C13238 + (C13551 + C13550) * C13237) * C31260 +
           ((C15553 + C15557) * C13237 +
            (C2299 * C13235 +
             (C113 * C2402 + C2412 + C2412 + C31151 * C2408) * C13236) *
                C13238) *
    ...
    d2ee[27] += (-std::sqrt(2.25) * 2 * std::pow(Pi, 2.5) *
                 ((((C18735 * C115 + C18740 + C18740 + C18733 * C129 +
                     C18737 * C480 + C18741 + C18741 + C18734 * C500) *
                        C13235 +
                    (C24650 + C24651) * C13236) *
                       C30904 * C30972 * C31271 -
                   ((C24652 + C24653) * C13236 + (C24651 + C24650) * C13235) *
                       C30904 * C30972 * C31267 +
                   ((C24653 + C24652) * C13235 + (C25510 + C25511) * C13236) *
                       C30904 * C30972 * C31257 -
                   ((C25512 + C25513) * C13236 + (C25511 + C25510) * C13235) *
                       C30904 * C30972 * C31237) *
                      C2618 +
                  (((C18987 + C18986) * C13235 + (C18988 + C18989) * C13236) *
                       C30904 * C30972 * C31267 -
                   ((C18986 + C18987) * C13236 + (C18785 + C18784) * C13235) *
        ...
        (-std::sqrt(2.25) * 2 * std::pow(Pi, 2.5) *
         (((((C113 * C115 + C137 + C137 + C31151 * C129) * C4733 +
           ...
           ((C5324 * C4733 + C5323 * C4734 + C5655 * C4735) * C30904 * C31059 -
            (C4862 * C4735 + C4861 * C4734 + C4860 * C4733) * C30904 * C31199) *
               C31020 +
           ((C4861 * C4733 + C4862 * C4734 + C5513 * C4735) * C30904 * C31199 -
            (C6025 * C4735 + C5655 * C4734 + C5323 * C4733) * C30904 * C31059) *
               C2878) *
              C2618 +
          (((C544 * C4733 + C957 * C4734 + C1596 * C4735) * C30904 * C31059 -
            (C356 * C4735 + C355 * C4734 + C164 * C4733) * C30904 * C31199) *
               C31013 +
           ((C355 * C4733 + C356 * C4734 + C1434 * C4735) * C30904 * C31199 -
            (C5918 * C4735 + C1596 * C4734 + C957 * C4733) * C30904 * C31059) *
               C31020 +
           ((C1596 * C4733 + C5918 * C4734 +
             (C113 * C5909 + C5915 + C5915 + C31151 * C5911) * C4735) *
                C30904 * C31059 -
            (C5763 * C4735 + C1434 * C4734 + C356 * C4733) * C30904 * C31199) *
               C2878) *
              C30937)) /
            (p * q * std::sqrt(p + q)) -
        (std::sqrt(2.25) * 2 * std::pow(Pi, 2.5) *
         (((((C113 * C115 + C137 + C137 + C31151 * C129) * C31138 * C103 +
          ...
          (((C550 * C103 + C549 * C104 + C553 * C105) * C31059 -
            (C171 * C105 + C170 * C104 + C169 * C103) * C31199) *
               C31013 +
           ((C361 * C103 + C360 * C104 + C364 * C105) * C31199 -
            (C962 * C105 + C961 * C104 + C960 * C103) * C31059) *
               C31020 +
           ((C1598 * C103 + C1597 * C104 +
             (C113 * C1582 + C1590 + C1590 + C31151 * C1584) * C31138 * C105) *
                C31059 -
            (C365 * C105 + C363 * C104 + C362 * C103) * C31199) *
               C2878) *
              C30937)) /
            (p * q * std::sqrt(p + q)) +
        (std::sqrt(9.) * 2 * std::pow(Pi, 2.5) *
    ...
    d2ee[52] +=
             ...
             ((((C113 * C115 + C137 + C137 + C31151 * C129) * C31138 * C103 +
               ...
               (C1435 * C105 + C1436 * C104 +
                (C113 * C1148 + C1167 + C1167 + C31151 * C1160) * C31138 *
                   ...
                   C30972 * C31237) *
                  C2618 +
              ((C361 * C103 + C360 * C104 + C364 * C105) * C30972 * C31267 -
               (C171 * C105 + C170 * C104 + C169 * C103) * C30972 * C31271 -
               (C365 * C105 + C363 * C104 + C362 * C103) * C30972 * C31257 +
           ...
           (((C113 * C924 + C940 + C940 + C31151 * C934) * C31138 * C103 +
            ...
            (C2183 * C105 + C2184 * C104 +
             (C113 * C1282 + C1310 + C1310 + C31151 * C1300) * C31138 * C103) *
               ...
               C31017) *
              C2618 +
          (((C550 * C103 + C549 * C104 + C553 * C105) * C31254 -
            (C171 * C105 + C170 * C104 + C169 * C103) * C31265 -
            (C554 * C105 + C552 * C104 + C551 * C103) * C31230) *
               C2510 +
           ((C361 * C103 + C360 * C104 + C364 * C105) * C31265 -
            (C962 * C105 + C961 * C104 + C960 * C103) * C31254 +
         ...
         (((((C113 * C115 + C137 + C137 + C31151 * C129) * C4733 +
            ...
            ((C113 * C481 + C516 + C516 + C31151 * C501) * C4733 +
             C5653 * C4734 + C5654 * C4735) *
                C30904 * C31230) *
               C2510 +
           ((C5324 * C4733 + C5323 * C4734 + C5655 * C4735) * C30904 * C31254 -
            (C4862 * C4735 + C4861 * C4734 + C4860 * C4733) * C30904 * C31265 -
            (C5656 * C4735 + C5654 * C4734 + C5653 * C4733) * C30904 * C31230) *
               C31017) *
              C2618 +
          (((C544 * C4733 + C957 * C4734 + C1596 * C4735) * C30904 * C31254 -
            (C356 * C4735 + C355 * C4734 + C164 * C4733) * C30904 * C31265 -
            (C6474 * C4735 + C2182 * C4734 + C545 * C4733) * C30904 * C31230) *
               C2510 +
           ((C355 * C4733 + C356 * C4734 + C1434 * C4735) * C30904 * C31265 -
            (C5918 * C4735 + C1596 * C4734 + C957 * C4733) * C30904 * C31254 +
        ...
        (std::sqrt(0.75) * 2 * std::pow(Pi, 2.5) *
         (((C8985 * C115 + C8992 + C8992 + C8982 * C129 + C8987 * C480 + C8993 +
            C8993 + C8983 * C500 + C8989 * C481 + C8994 + C8994 +
            C8984 * C501) *
               C31138 * C30904 * C30972 * C31271 -
           (C8989 * C1282 + C9117 + C9117 + C8984 * C1300 + C8987 * C924 +
            C9118 + C9118 + C8983 * C934 + C8985 * C291 + C9119 + C9119 +
            C8982 * C311) *
               C31138 * C30904 * C30972 * C31267 +
           (C8985 * C292 + C9120 + C9120 + C8982 * C312 + C8987 * C1285 +
            C9121 + C9121 + C8983 * C1303 + C8989 * C1286 + C9122 + C9122 +
            C8984 * C1304) *
               C31138 * C30904 * C30972 * C31257 -
           (C8989 * C5624 + C9792 + C9792 + C8984 * C5630 + C8987 * C1696 +
            C9793 + C9793 + C8983 * C1702 + C8985 * C1148 + C9794 + C9794 +
            C8982 * C1160) *
               C31138 * C30904 * C30972 * C31237) *
              C2618 +
          ((C8985 * C290 + C9123 + C9123 + C8982 * C310 + C8987 * C925 + C9124 +
            C9124 + C8983 * C935 + C8989 * C1281 + C9125 + C9125 +
            C8984 * C1299) *
         ...
         ((((C113 * C115 + C137 + C137 + C31151 * C129) * C4733 +
           ...
           (C6687 * C4735 + C6688 * C4734 +
            (C113 * C2000 + C2019 + C2019 + C31151 * C2012) * C4733) *
               C30904 * C31243) *
              C2510 +
          ((C5324 * C4733 + C5323 * C4734 + C5655 * C4735) * C30904 * C31269 -
           (C4862 * C4735 + C4861 * C4734 + C4860 * C4733) * C30904 * C31272 -
           (C5656 * C4735 + C5654 * C4734 + C5653 * C4733) * C30904 * C31260 +
             ...
             ((((C113 * C115 + C137 + C137 + C31151 * C129) * C31138 * C103 +
               ...
               (C360 * C105 + C361 * C104 +
                (C113 * C291 + C326 + C326 + C31151 * C311) * C31138 * C103) *
                  ...
                  C654 +
              ((C361 * C103 + C360 * C104 + C364 * C105) * C30972 * C31017 -
               (C171 * C105 + C170 * C104 + C169 * C103) * C30972 * C31198) *
                  C655 +
              ((C170 * C103 + C171 * C104 + C172 * C105) * C30972 * C31198 -
               (C668 * C105 + C364 * C104 + C360 * C103) * C30972 * C31017) *
                  C656 +
              ((C364 * C103 + C668 * C104 +
                (C113 * C658 + C664 + C664 + C31151 * C660) * C31138 * C105) *
                   C30972 * C31017 -
               (C173 * C105 + C172 * C104 + C171 * C103) * C30972 * C31198) *
                  C31231) +
         std::sqrt(0.1875) * 2 * std::pow(Pi, 2.5) *
             ((((C113 * C115 + C137 + C137 + C31151 * C129) * C31138 * C103 +
                C169 * C104 + C170 * C105) *
        ...
        (std::sqrt(0.1875) * 2 * std::pow(Pi, 2.5) *
         ((((C113 * C115 + C137 + C137 + C31151 * C129) * C4733 +
          ...
          ((C5655 * C4733 + C6025 * C4734 +
            (C113 * C6016 + C6022 + C6022 + C31151 * C6018) * C4735) *
               C30904 * C31059 -
           (C5514 * C4735 + C5513 * C4734 + C4862 * C4733) * C30904 * C31199) *
              C31237) *
         C30926) /
            (p * q * std::sqrt(p + q)) -
        (std::sqrt(0.75) * 2 * std::pow(Pi, 2.5) *
    ...
    d2ee[62] +=
             ...
             ((((C113 * C115 + C137 + C137 + C31151 * C129) * C31138 * C103 +
               ...
               ((C113 * C292 + C327 + C327 + C31151 * C312) * C31138 * C103 +
                C362 * C104 + C363 * C105) *
                   C30972 * C31227) *
                  C286 +
              ((C361 * C103 + C360 * C104 + C364 * C105) * C30972 * C31252 -
               (C171 * C105 + C170 * C104 + C169 * C103) * C30972 * C31264 -
               (C365 * C105 + C363 * C104 + C362 * C103) * C30972 * C31227) *
                  C287 +
              ((C170 * C103 + C171 * C104 + C172 * C105) * C30972 * C31264 -
         ...
         0.5 * std::pow(Pi, 2.5) *
             ((((C113 * C115 + C137 + C137 + C31151 * C129) * C31138 * C103 +
              ...
              ((C550 * C103 + C549 * C104 + C553 * C105) * C31254 -
               ...
               (C554 * C105 + C552 * C104 + C551 * C103) * C31230) *
                  C30954 * C287 +
              ((C170 * C103 + C171 * C104 + C172 * C105) * C31265 -
          ...
          ((C544 * C4733 + C957 * C4734 + C1596 * C4735) * C30904 * C31254 -
           ...
           ((C113 * C1287 + C1315 + C1315 + C31151 * C1305) * C4735 +
            C2182 * C4734 + C545 * C4733) *
               C30904 * C31230) *
              C30954 * C287 +
          ((C165 * C4733 + C354 * C4734 + C357 * C4735) * C30904 * C31265 -
           (C1595 * C4735 + C958 * C4734 + C543 * C4733) * C30904 * C31254 +
        ...
        (0.5 * std::pow(Pi, 2.5) *
         ((((C113 * C115 + C137 + C137 + C31151 * C129) * C4733 +
          ...
          ((C5324 * C4733 + C5323 * C4734 + C5655 * C4735) * C30904 * C31254 -
           ...
           (C5656 * C4735 + C5654 * C4734 + C5653 * C4733) * C30904 * C31230) *
              C1073 +
          ((C4861 * C4733 + C4862 * C4734 + C5513 * C4735) * C30904 * C31265 -
        ...
        (0.5 * std::pow(Pi, 2.5) *
         (((C8985 * C115 + C8992 + C8992 + C8982 * C129 + C8987 * C480 + C8993 +
            C8993 + C8983 * C500 + C8989 * C481 + C8994 + C8994 +
            C8984 * C501) *
               C31138 * C30904 * C30972 * C31264 -
           (C8989 * C1282 + C9117 + C9117 + C8984 * C1300 + C8987 * C924 +
            C9118 + C9118 + C8983 * C934 + C8985 * C291 + C9119 + C9119 +
            C8982 * C311) *
               C31138 * C30904 * C30972 * C31252 +
           (C8985 * C292 + C9120 + C9120 + C8982 * C312 + C8987 * C1285 +
            C9121 + C9121 + C8983 * C1303 + C8989 * C1286 + C9122 + C9122 +
            C8984 * C1304) *
               C31138 * C30904 * C30972 * C31227) *
              C286 +
          ((C8985 * C290 + C9123 + C9123 + C8982 * C310 + C8987 * C925 + C9124 +
            C9124 + C8983 * C935 + C8989 * C1281 + C9125 + C9125 +
            C8984 * C1299) *
             ...
             ((((C113 * C115 + C137 + C137 + C31151 * C129) * C31138 * C103 +
              ...
              ((C553 * C103 + C778 * C104 +
                (C113 * C768 + C774 + C774 + C31151 * C770) * C31138 * C105) *
                   C31059 -
               (C173 * C105 + C172 * C104 + C171 * C103) * C31199) *
                  C30954 * C31231) +
         std::sqrt(0.1875) * 2 * std::pow(Pi, 2.5) *
             (((((C113 * C115 + C137 + C137 + C31151 * C129) * C31138 * C103 +
                 C169 * C104 + C170 * C105) *
         ...
         ((((C113 * C115 + C137 + C137 + C31151 * C129) * C4733 +
          ...
          ((C547 * C4733 + C959 * C4734 +
            (C113 * C1582 + C1590 + C1590 + C31151 * C1584) * C4735) *
               C30904 * C31059 -
           (C359 * C4735 + C358 * C4734 + C166 * C4733) * C30904 * C31199) *
              C30954 * C31231)) /
            (p * q * std::sqrt(p + q)) +
        (std::sqrt(0.1875) * 2 * std::pow(Pi, 2.5) *
         (((((C113 * C115 + C137 + C137 + C31151 * C129) * C4733 +
         ...
         ((((C113 * C115 + C137 + C137 + C31151 * C129) * C31138 * C103 +
           ...
           (C2301 * C105 + C2302 * C104 +
            (C113 * C2000 + C2019 + C2019 + C31151 * C2012) * C31138 * C103) *
               C31243) *
              C30954 * C2618 +
          ((C550 * C103 + C549 * C104 + C553 * C105) * C31269 -
           (C171 * C105 + C170 * C104 + C169 * C103) * C31272 -
           (C554 * C105 + C552 * C104 + C551 * C103) * C31260 +
           (C2302 * C103 + C2301 * C104 +
            (C113 * C2286 + C2294 + C2294 + C31151 * C2288) * C31138 * C105) *
               C31243) *
              C30954 * C30937)) /
         ...
         ((((C113 * C115 + C137 + C137 + C31151 * C129) * C4733 +
           ...
           (C6687 * C4735 + C6688 * C4734 +
            (C113 * C2000 + C2019 + C2019 + C31151 * C2012) * C4733) *
               C30904 * C31243) *
              C30954 * C2618 +
          ((C544 * C4733 + C957 * C4734 + C1596 * C4735) * C30904 * C31269 -
           (C356 * C4735 + C355 * C4734 + C164 * C4733) * C30904 * C31272 -
           (C6474 * C4735 + C2182 * C4734 + C545 * C4733) * C30904 * C31260 +
           (C2300 * C4733 +
            (C113 * C2401 + C2411 + C2411 + C31151 * C2407) * C4734 +
            (C113 * C6572 + C6576 + C6576 + C31151 * C6574) * C4735) *
               C30904 * C31243) *
