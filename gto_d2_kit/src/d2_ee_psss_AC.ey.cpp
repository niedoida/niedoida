...
//
void second_derivative_ee_1000_13(const double ae,
                                  const double xA,
                                  const double yA,
                                  const double zA,
                                  const double be,
                                  ...
                                  double* const d2eezz)
{
    ...
    const double C402 = xA - xB;
    const double C401 = ae + be;
    ...
    const double C65 =
        (-((std::pow(xP - xQ, 2) * bs[2] * std::pow(C435 / C434, 2) -
         ...
         (ce + de)) /
        C401;
    const double C61 = (-(bs[1] * C439 * ae * C435) / C434) / C401;
    ...
    const double C108 = (-(bs[1] * C445 * ae * C435) / C434) / C401;
    const double C147 = (-(bs[1] * C448 * ae * C435) / C434) / C401;
    ...
    const double C554 = C550 / C401;
    const double C555 = C552 / C401;
    const double C556 = C553 / C401;
    ...
    const double C123 =
        (-(C439 *
         ...
         C440) /
        C401;
    const double C134 = (-(C441 * C438 * C445 * C448 * ae * ce) / C440) / C401;
    const double C149 = (-(C441 * C438 * C448 * C439 * ae * ce) / C440) / C401;
    const double C150 =
        (-(C439 * std::pow(-C437, 3) * bs[3] * C448 * C439 * ae * ce) / C440) /
            C401 -
        (C441 * C438 * C448 * ae * ce) / C442;
    const double C161 = (-(C441 * C438 * C448 * C445 * ae * ce) / C440) / C401;
    const double C173 =
    ...
    const double C230 =
        ...
        (ae * C441 * C438 * C439 * ce) / C442;
    const double C241 =
        (-(C441 * C438 * C445 * ae * ce) / C440) / C401 -
        (ae * C441 * C438 * C445 * ce) / C442 -
    ...
    const double C385 =
        ...
        (ae * C441 * C438 * C445 * ce) / C442;
    const double C396 =
        (-(C441 * C438 * C448 * ae * ce) / C440) / C401 -
        (ae * C441 * C438 * C448 * ce) / C442 -
        (C448 * (C438 * C441 + std::pow(C448, 2) * bs[3] * std::pow(-C437, 3)) *
         ae * ce) /
            C442;
    const double C62 = (C439 * C441 * C438 * C439 * ae) / C401 -
                       (ae * bs[1] * C435) / (C434 * C401);
    ...
    const double C109 = (C439 * C441 * C438 * C445 * ae) / C401;
    const double C148 = (C439 * C441 * C438 * C448 * ae) / C401;
    const double C190 = (C445 * C441 * C438 * C439 * ae) / C401;
    ...
    const double C229 = (C445 * C441 * C438 * C445 * ae) / C401 -
                        (ae * bs[1] * C435) / (C434 * C401);
    const double C263 = (C445 * C441 * C438 * C448 * ae) / C401;
    const double C300 = (C448 * C441 * C438 * C439 * ae) / C401;
    ...
    const double C337 = (C448 * C441 * C438 * C445 * ae) / C401;
    const double C373 = (C448 * C441 * C438 * C448 * ae) / C401 -
                        (ae * bs[1] * C435) / (C434 * C401);
    ...
    const double C56 =
        (-(0 * be) / C401) / (2 * C401) -
        ((C560 - (C402 * 2 * ae * be * C402 * C560) / C401) * be) / C401;
    const double C57 =
        (-(2 * ae * be * C402 * C560) / C401) / (2 * C401) - (0 * be) / C401;
    const double C188 = -(2 * ae * be * C402 * C560) / C401;
    const double C49 = -(C560 * C402 * be) / C401;
    const double C50 = C551 * C560;
    const double C107 = -(2 * ae * be * (yA - yB) * C561) / C401;
    const double C227 =
        (-(0 * be) / C401) / (2 * C401) -
        ((C561 - (C421 * 2 * ae * be * C421 * C561) / C401) * be) / C401;
    const double C228 =
        (-(2 * ae * be * C421 * C561) / C401) / (2 * C401) - (0 * be) / C401;
    const double C186 = -(C561 * C421 * be) / C401;
    const double C187 = C551 * C561;
    const double C146 = -(2 * ae * be * (zA - zB) * C562) / C401;
    const double C371 =
        (-(0 * be) / C401) / (2 * C401) -
        ((C562 - (C428 * 2 * ae * be * C428 * C562) / C401) * be) / C401;
    const double C372 =
        (-(2 * ae * be * C428 * C562) / C401) / (2 * C401) - (0 * be) / C401;
    const double C297 = -(C562 * C428 * be) / C401;
