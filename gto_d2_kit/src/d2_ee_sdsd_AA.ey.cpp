...
//
void second_derivative_ee_0202_11(const double ae,
                                  const double xA,
                                  const double yA,
                                  const double zA,
                                  const double be,
                                  ...
                                  double* const d2eezz)
{
    ...
    const double C19857 = 2 * C19738;
    const double C19856 = std::pow(C19738, 2);
    const double C19739 = std::pow(C19736, 2);
    const double C19855 = C19736 * ce;
    const double C19751 = std::pow(C19750, 2);
    const double C19858 = C19750 * ce;
    const double C19765 = std::pow(C19764, 2);
    const double C19859 = C19764 * ce;
    const double C19718 = C19717 * C18801;
    const double C18806 = 2 * C18802;
    const double C19864 = std::pow(C19854, -2);
    const double C19862 = std::pow(C19854, -1);
    ...
    const double C19867 = std::pow(C19857, -2);
    const double C19865 = std::pow(C19857, -1);
    ...
    const double C18805 = C18803 * C19721;
    const double C19863 = C19721 * C19853;
    const double C77 =
        (C19721 * std::pow(C19853, 2)) / C18802 + C19721 / C19854;
    const double C79 = C19864 * C19721;
    const double C8564 = C19862 * C19721;
    ...
    const double C332 =
        -((C19794 - (C18833 * 2 * C18801 * C18833 * C19794) / C18799) *
          C18804) /
        C18799;
    const double C19870 = C19794 * C19860;
    const double C3080 =
        (C19794 * std::pow(C19860, 2)) / C18802 + C19794 / C19854;
    const double C3082 = C19864 * C19794;
    const double C8566 = C19862 * C19794;
    ...
    const double C557 =
        -((C19805 - (C18836 * 2 * C18801 * C18836 * C19805) / C18799) *
          C18804) /
        C18799;
    const double C19871 = C19805 * C19861;
    const double C5850 =
        (C19805 * std::pow(C19861, 2)) / C18802 + C19805 / C19854;
    const double C5852 = C19864 * C19805;
    const double C12051 = C19862 * C19805;
    ...
    const double C19866 = C19743 * C19855;
    const double C84 =
        (C19743 * std::pow(C19855, 2)) / C19856 + C19743 / C19857;
    const double C86 = C19867 * C19743;
    const double C1522 = C19865 * C19743;
    const double C19868 = C19755 * C19858;
    const double C624 =
        (C19755 * std::pow(C19858, 2)) / C19856 + C19755 / C19857;
    const double C626 = C19867 * C19755;
    const double C1520 = C19865 * C19755;
    const double C19869 = C19769 * C19859;
    const double C1066 =
        (C19769 * std::pow(C19859, 2)) / C19856 + C19769 / C19857;
    const double C1068 = C19867 * C19769;
    const double C2058 = C19865 * C19769;
    const double C18807 = 2 * C18805;
    const double C92 = ((0 * ae) / C18799 - C18805 / C18802) / (2 * C18799) +
                       (0 * ae) / C18799;
    const double C8570 = (0 * ae) / C18799 - C18805 / C18802;
    const double C78 = (2 * C19862 * C19863) / C18799;
    const double C8563 = C19863 / C18799;
    const double C18857 = 2 * C18849;
    const double C3134 = ((0 * ae) / C18799 - C18849 / C18802) / (2 * C18799) +
                         (0 * ae) / C18799;
    const double C8634 = (0 * ae) / C18799 - C18849 / C18802;
    ...
    const double C3081 = (2 * C19862 * C19870) / C18799;
    const double C8565 = C19870 / C18799;
    const double C3133 =
        (((C19794 - (C18833 * 2 * C18849) / C18799) * ae) / C18799 -
         C18847 / C18806) /
            (2 * C18799) +
        ((C18833 * ((0 * ae) / C18799 - C18849 / C18802) + C8566) * ae) /
            C18799;
    const double C18883 = 2 * C18875;
    const double C5934 = ((0 * ae) / C18799 - C18875 / C18802) / (2 * C18799) +
                         (0 * ae) / C18799;
    const double C12155 = (0 * ae) / C18799 - C18875 / C18802;
    ...
    const double C5851 = (2 * C19862 * C19871) / C18799;
    const double C12050 = C19871 / C18799;
    const double C5933 =
        (((C19805 - (C18836 * 2 * C18875) / C18799) * ae) / C18799 -
         C18873 / C18806) /
            (2 * C18799) +
        ((C18836 * ((0 * ae) / C18799 - C18875 / C18802) + C12051) * ae) /
            C18799;
    ...
    const double C85 = (2 * C19865 * C19866) / C19738;
    const double C1521 = C19866 / C19738;
    const double C625 = (2 * C19865 * C19868) / C19738;
    const double C1519 = C19868 / C19738;
    const double C1067 = (2 * C19865 * C19869) / C19738;
    const double C2057 = C19869 / C19738;
    ...
    const double C18858 = C18833 * C18857;
    ...
    const double C3132 =
        (((0 - (C18833 * C18847) / C18799) * ae) / C18799 - (0 * be) / C18806) /
            (2 * C18799) +
        ((C18833 * (((C19794 - (C18833 * 2 * C18849) / C18799) * ae) / C18799 -
                    C18847 / C18806) +
          C8565) *
         ae) /
            C18799 +
        (0 * ae) / C18799 - C18849 / C18802;
    const double C3260 = C3133 * C690;
    const double C3257 = C3133 * C691;
    const double C3254 = C3133 * C692;
    const double C18884 = C18836 * C18883;
    ...
    const double C5932 =
        (((0 - (C18836 * C18873) / C18799) * ae) / C18799 - (0 * be) / C18806) /
            (2 * C18799) +
        ((C18836 * (((C19805 - (C18836 * 2 * C18875) / C18799) * ae) / C18799 -
                    C18873 / C18806) +
          C12050) *
         ae) /
            C18799 +
        (0 * ae) / C18799 - C18875 / C18802;
    ...
    const double C18811 = C18810 * C18804;
    const double C88 =
        (((0 - (C18800 * C18798) / C18799) * ae) / C18799 - (0 * be) / C18806) /
            (2 * C18799) +
        ((C18800 * ((C18810 * ae) / C18799 - C18798 / C18806) + C8563) * ae) /
            C18799 +
        (0 * ae) / C18799 - C18805 / C18802;
    const double C90 =
        ((C18810 * ae) / C18799 - C18798 / C18806) / (2 * C18799) +
        ((C18800 * ((0 * ae) / C18799 - C18805 / C18802) + C8564) * ae) /
            C18799;
    const double C8568 = (C18810 * ae) / C18799 - C18798 / C18806;
    ...
    const double C18861 = C18860 * C18804;
    const double C8633 = (C18860 * ae) / C18799 - C18847 / C18806;
    const double C6819 = C6816 * C19721;
    const double C13294 = C6816 * C8563;
    const double C18887 = C18886 * C18804;
    const double C12154 = (C18886 * ae) / C18799 - C18873 / C18806;
    ...
    const double C87 =
        (ae * -2 * C18798) / (C18802 * 2 * C18799) +
        (((C18800 * ((-4 * C18805) / C18799 - (C18800 * C18811) / C18799) *
           ae) /
              C18799 +
          2 * ((C18810 * ae) / C18799 - C18798 / C18806)) *
         ae) /
            C18799 -
        C18811 / C18806;
    const double C91 = (-C18811 / C18799) / (4 * C18802);
    const double C3083 = -C18811 / C18799;
    const double C8569 = (-C18811 / C18799) / (2 * C18799);
    ...
    const double C3249 =
        (ae * -2 * C18847) / (C18802 * 2 * C18799) +
        (((C18833 * ((-4 * C18849) / C18799 - (C18833 * C18861) / C18799) *
           ae) /
              C18799 +
          2 * ((C18860 * ae) / C18799 - C18847 / C18806)) *
         ae) /
            C18799 -
        C18861 / C18806;
    const double C3251 = (-C18861 / C18799) / (4 * C18802);
    const double C8810 = (-C18861 / C18799) / (2 * C18799);
    ...
    const double C6163 =
        (ae * -2 * C18873) / (C18802 * 2 * C18799) +
        (((C18836 * ((-4 * C18875) / C18799 - (C18836 * C18887) / C18799) *
           ae) /
              C18799 +
          2 * ((C18886 * ae) / C18799 - C18873 / C18806)) *
         ae) /
            C18799 -
        C18887 / C18806;
    const double C6165 = (-C18887 / C18799) / (4 * C18802);
    const double C12501 = (-C18887 / C18799) / (2 * C18799);
    ...
    const double C8170 =
        ...
        C18799;
    const double C89 =
        (((-4 * C18805) / C18799 - C18819 / C18799) * ae) / C18806 +
        ((2 * ((0 * ae) / C18799 - C18805 / C18802) - C18819 / C18806) * ae) /
            C18799;
    const double C8567 =
        (((-4 * C18805) / C18799 - C18819 / C18799) * ae) / C18799;
    ...
    const double C3250 =
        (((-4 * C18849) / C18799 - C18864 / C18799) * ae) / C18806 +
        ((2 * ((0 * ae) / C18799 - C18849 / C18802) - C18864 / C18806) * ae) /
            C18799;
    const double C8809 =
        (((-4 * C18849) / C18799 - C18864 / C18799) * ae) / C18799;
    ...
    const double C6164 =
        (((-4 * C18875) / C18799 - C18890 / C18799) * ae) / C18806 +
        ((2 * ((0 * ae) / C18799 - C18875 / C18802) - C18890 / C18806) * ae) /
            C18799;
    const double C12500 =
        (((-4 * C18875) / C18799 - C18890 / C18799) * ae) / C18799;
