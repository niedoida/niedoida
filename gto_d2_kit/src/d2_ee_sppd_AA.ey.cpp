...
//
void second_derivative_ee_0112_11(const double ae,
                                  const double xA,
                                  const double yA,
                                  const double zA,
                                  const double be,
                                  ...
                                  double* const d2eezz)
{
    ...
    const double C73 = (C26968 * C25914 * ae) / C25915;
    ...
    const double C309 =
        ...
        C25915;
    const double C9097 =
        ((C26970 - (C25932 * 2 * C25913 * C25932 * C26970) / C25915) * ae) /
            C25915 -
        (0 * be) / (2 * std::pow(C25915, 2));
    const double C9098 =
        (0 * ae) / C25915 - (C25913 * C25932 * C26970) / std::pow(C25915, 2);
    const double C9051 = (C26970 * C25932 * ae) / C25915;
    ...
    const double C516 =
        ...
        C25915;
    const double C17630 =
        ((C26969 - (C25935 * 2 * C25913 * C25935 * C26969) / C25915) * ae) /
            C25915 -
        (0 * be) / (2 * std::pow(C25915, 2));
    const double C17631 =
        (0 * ae) / C25915 - (C25913 * C25935 * C26969) / std::pow(C25915, 2);
    const double C17559 = (C26969 * C25935 * ae) / C25915;
    ...
    const double C83 =
        ...
        C25915;
    const double C84 =
        ((C26968 - (C25914 * 2 * C25917) / C25915) * ae) / C25915 -
        (0 * be) / (2 * std::pow(C25915, 2));
    const double C85 =
        (-((C26968 - (C25914 * 2 * C25917) / C25915) * 2 * C25913) / C25915) /
        (2 * C25915);
    const double C86 = (0 * ae) / C25915 - C25917 / std::pow(C25915, 2);
    const double C9053 =
        -((C26968 - (C25914 * 2 * C25917) / C25915) * 2 * C25913) / C25915;
