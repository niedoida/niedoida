...
void vne_second_derivative_02_33(double ae,
                                 double be,
                                 double xA,
                                 double yA,
                                 double zA,
                                 ...
                                 std::size_t Bi)
{
    ...
    const double C320 = C299 * ae;
    const double C319 = C289 * ae;
    ...
    const double d2neyz000200 = (2 * Pi *
    ...
    const double d2nezy000200 = (2 * Pi *
