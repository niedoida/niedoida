...
void vne_second_derivative_00_11(double ae,
                                 double be,
                                 double xA,
                                 double yA,
                                 double zA,
                                 ...
                                 std::size_t Bi)
{
    ...
    const double C136 = ae * be;
    const double C59 = std::exp(-(std::pow(xA - xB, 2) * C136) / C137);
    const double C60 = std::exp(-(std::pow(zA - zB, 2) * C136) / C137);
    const double C61 = std::exp(-(std::pow(yA - yB, 2) * C136) / C137);
    ...
    const double C103 = ae * C98;
    const double C102 = C68 * C97;
    const double C101 = ae * C96;
    ...
    const double C129 = C123 / C64;
    const double C128 = C122 / C64;
    const double C127 = C121 + C111;
    const double C126 = C120 + C110;
    const double C125 = C119 + C108;
    const double C124 = C118 / C64;
    const double d2nexx000000 =
        (2 * Pi *
         (C124 - (C68 * (C59 - (C67 * C95) / C64) * C79) / C64 + C124 +
    ...
    const double d2nexy000000 =
        (2 * Pi *
         ((C125 * C95) / C64 +
          ((2 * C106 * C97) / C64 + (C61 * C88 * C69 * C94 * C96 * C70) / C81) *
              C59) *
         C60) /
        C64;
    ...
    const double d2nexz000000 =
        (2 * Pi *
         ((C126 * C95) / C64 +
          ((2 * C106 * C99) / C64 + (C60 * C88 * C69 * C94 * C98 * C70) / C81) *
              C59) *
         C61) /
        C64;
    ...
    const double d2neyx000000 =
        (2 * Pi *
         ((C127 * C97) / C64 +
          ((2 * C107 * C95) / C64 + (C59 * C88 * C69 * C96 * C94 * C70) / C81) *
              C61) *
         C60) /
        C64;
    ...
    const double d2neyy000000 =
        (2 * Pi *
         (C128 - (C68 * (C61 - (C73 * C97) / C64) * C79) / C64 + C128 +
    ...
    const double d2neyz000000 =
        (2 * Pi *
         ((C126 * C97) / C64 +
          ((2 * C107 * C99) / C64 + (C60 * C88 * C69 * C96 * C98 * C70) / C81) *
              C61) *
         C59) /
        C64;
    ...
    const double d2nezx000000 =
        (2 * Pi *
         ((C127 * C99) / C64 +
          ((2 * C109 * C95) / C64 + (C59 * C88 * C69 * C98 * C94 * C70) / C81) *
              C60) *
         C61) /
        C64;
    ...
    const double d2nezy000000 =
        (2 * Pi *
         ((C125 * C99) / C64 +
          ((2 * C109 * C97) / C64 + (C61 * C88 * C69 * C98 * C96 * C70) / C81) *
              C60) *
         C59) /
        C64;
    ...
    const double d2nezz000000 =
        (2 * Pi *
         (C129 - (C68 * (C60 - (C76 * C99) / C64) * C79) / C64 + C129 +
