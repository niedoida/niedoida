...
namespace niedoida {
    namespace gto {
        void svr1_4(const double alpha_over_p,
        ...
        {
            *(b + 1 * OS1_S1 + 0) = alpha_X * *(b + 0 * OS1_S1 + 1);
            *(b + 2 * OS1_S1 + 0) = alpha_Y * *(b + 0 * OS1_S1 + 1);
            *(b + 3 * OS1_S1 + 0) = alpha_Z * *(b + 0 * OS1_S1 + 1);
            if (m > 1) {
                *(b + 1 * OS1_S1 + 1) = alpha_X * *(b + 0 * OS1_S1 + 2);
                *(b + 2 * OS1_S1 + 1) = alpha_Y * *(b + 0 * OS1_S1 + 2);
                *(b + 3 * OS1_S1 + 1) = alpha_Z * *(b + 0 * OS1_S1 + 2);
                *(b + 4 * OS1_S1 + 0) =
                    alpha_X * *(b + 1 * OS1_S1 + 1) +
                    one_over_two_p * (*(b + 0 * OS1_S1 + 0) -
                                      alpha_over_p * *(b + 0 * OS1_S1 + 1));
                *(b + 5 * OS1_S1 + 0) = alpha_Y * *(b + 1 * OS1_S1 + 1);
                *(b + 6 * OS1_S1 + 0) = alpha_Z * *(b + 1 * OS1_S1 + 1);
                *(b + 7 * OS1_S1 + 0) =
                    alpha_Y * *(b + 2 * OS1_S1 + 1) +
                    one_over_two_p * (*(b + 0 * OS1_S1 + 0) -
                                      alpha_over_p * *(b + 0 * OS1_S1 + 1));
                *(b + 8 * OS1_S1 + 0) = alpha_Z * *(b + 2 * OS1_S1 + 1);
                *(b + 9 * OS1_S1 + 0) =
                    alpha_Z * *(b + 3 * OS1_S1 + 1) +
                    one_over_two_p * (*(b + 0 * OS1_S1 + 0) -
                                      alpha_over_p * *(b + 0 * OS1_S1 + 1));
                if (m > 2) {
                    *(b + 1 * OS1_S1 + 2) = alpha_X * *(b + 0 * OS1_S1 + 3);
                    *(b + 2 * OS1_S1 + 2) = alpha_Y * *(b + 0 * OS1_S1 + 3);
                    *(b + 3 * OS1_S1 + 2) = alpha_Z * *(b + 0 * OS1_S1 + 3);
                    *(b + 4 * OS1_S1 + 1) =
                        alpha_X * *(b + 1 * OS1_S1 + 2) +
                        one_over_two_p * (*(b + 0 * OS1_S1 + 1) -
                                          alpha_over_p * *(b + 0 * OS1_S1 + 2));
                    *(b + 5 * OS1_S1 + 1) = alpha_Y * *(b + 1 * OS1_S1 + 2);
                    *(b + 7 * OS1_S1 + 1) =
                    ...
                    *(b + 11 * OS1_S1 + 0) = alpha_Y * *(b + 4 * OS1_S1 + 1);
                    *(b + 12 * OS1_S1 + 0) = alpha_Z * *(b + 4 * OS1_S1 + 1);
                    *(b + 13 * OS1_S1 + 0) = alpha_X * *(b + 7 * OS1_S1 + 1);
                    *(b + 14 * OS1_S1 + 0) = alpha_Z * *(b + 5 * OS1_S1 + 1);
                    *(b + 15 * OS1_S1 + 0) = alpha_X * *(b + 9 * OS1_S1 + 1);
                    *(b + 16 * OS1_S1 + 0) =
                        alpha_Y * *(b + 7 * OS1_S1 + 1) +
                        2 * one_over_two_p *
                            (*(b + 2 * OS1_S1 + 0) -
                             alpha_over_p * *(b + 2 * OS1_S1 + 1));
                    *(b + 17 * OS1_S1 + 0) = alpha_Z * *(b + 7 * OS1_S1 + 1);
                    *(b + 18 * OS1_S1 + 0) = alpha_Y * *(b + 9 * OS1_S1 + 1);
                    *(b + 19 * OS1_S1 + 0) =
                    ...
                    if (m > 3) {
                        *(b + 1 * OS1_S1 + 3) = alpha_X * *(b + 0 * OS1_S1 + 4);
                        *(b + 2 * OS1_S1 + 3) = alpha_Y * *(b + 0 * OS1_S1 + 4);
                        *(b + 3 * OS1_S1 + 3) = alpha_Z * *(b + 0 * OS1_S1 + 4);
                        *(b + 4 * OS1_S1 + 2) =
