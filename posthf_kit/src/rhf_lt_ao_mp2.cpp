    ...
    namespace posthf {
            ...
            m_indices_buf4(new std::size_t[m_n])
        {
            ...
            for (unsigned iii = 0; iii < quadrature.size(); iii++) {
                ...
                {
                    niedoida::io::Log::Section section("building batchs");
...

                {
                    ...
                    while (niedoida::misc::Dispatcher::TaskInfo task_info =
                        ...
                        for (std::size_t p = task_info->first;
                            ...
                            niedoida::io::Log::instance().write(
                                niedoida::io::Logger::DEBUG, "pass", int(p));
                            ...
                            niedoida::io::Log::instance().write(
                                niedoida::io::Logger::DEBUG, "ie", int(ie));
                ...
                niedoida::io::Log::instance().write(
                    niedoida::io::Logger::DEBUG, "partial MP2 energy", m_e2);

            } // quadrature point
        }

        unsigned long long RHF_LT_AO_MP2::subd2_size(std::size_t ib,
                                                     std::size_t ie)
        {
        ...
        void
        RHF_LT_AO_MP2::trans12(std::size_t ib, std::size_t ie, Integrals& d2)
        {
        ...
        void
        RHF_LT_AO_MP2::make_d2(std::size_t ib, std::size_t ie, Integrals& d2)
        {
#ifdef HAVE_MALLINFO
        ...
        void RHF_LT_AO_MP2::make_partial_d3(std::size_t ib,
                                            std::size_t ie,
                                            std::size_t* J,
                                            std::size_t J_size,
                                            Integrals& d3)
        ...
        void RHF_LT_AO_MP2::make_partial_d4(std::size_t ib,
                                            std::size_t ie,
                                            std::size_t* J,
                                            std::size_t J_size,
                                            Integrals& d4)
        ...
        void RHF_LT_AO_MP2::trans_partial_3(std::size_t ib,
                                            std::size_t ie,
                                            std::size_t* J_set,
                                            std::size_t J_size,
                                            Integrals& d2,
        ...
        void RHF_LT_AO_MP2::trans_partial_4(std::size_t ib,
                                            std::size_t ie,
                                            std::size_t* J_set,
                                            std::size_t J_size,
                                            Integrals& d3,
        ...
        void RHF_LT_AO_MP2::trans3partial(std::size_t i,
                                          std::size_t j,
                                          std::size_t k,
                                          std::size_t l,
                                          double g,
        ...
        void RHF_LT_AO_MP2::trans4partial(std::size_t i,
                                          std::size_t j,
                                          std::size_t k,
                                          std::size_t l,
                                          double g,
        ...
        void RHF_LT_AO_MP2::make_partial_d_sh(Integrals_sh& d_sh,
                                              const Integrals& d4)
        {
#ifdef HAVE_MALLINFO
            struct mallinfo minfo0 = mallinfo();
        ...
        double RHF_LT_AO_MP2::energy_partial_contribution(Integrals_sh& d_sh,
                                                          const Integrals& d4)
        {
        ...
        void RHF_LT_AO_MP2::make_local_matrices(const std::size_t ib,
                                                const std::size_t ie)
        {
