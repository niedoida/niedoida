...
void parse_fill_optional(const YAML::Node& root,
    ...
    filler.target(id.method).fill_optional_scalar("method");
    filler.target(id.energy).fill_optional_scalar("energy");
    filler.target(id.s1.pA.x).fill_optional_scalar("segments", 0, "pA", "x");
    filler.target(id.s1.pA.y).fill_optional_scalar("segments", 0, "pA", "y");
    filler.target(id.s1.pB.x).fill_optional_scalar("segments", 0, "pB", "x");
    filler.target(id.s1.pB.y).fill_optional_scalar("segments", 0, "pB", "y");
    filler.target(id.s2.pA.x).fill_optional_scalar("segments", 1, "pA", "x");
    filler.target(id.s2.pA.y).fill_optional_scalar("segments", 1, "pA", "y");
    filler.target(id.s2.pB.x).fill_optional_scalar("segments", 1, "pB", "x");
    filler.target(id.s2.pB.y).fill_optional_scalar("segments", 1, "pB", "y");
}

// *****************************************************************************

TEST(templated_filler, fill_optional_scalar_test_case_0) {
...
TEST(templated_filler, fill_optional_scalar_test_case_1) {
    std::string correct_log = "\
[INFO] Filler filled optional field $ROOT->method successfully.\n\
[INFO] Filler filled optional field $ROOT->energy successfully.\n\
...
TEST(templated_filler, fill_optional_scalar_test_case_2) {
    std::string correct_log = "\
[INFO] Filler filled optional field $ROOT->method successfully.\n\
[INFO] Filler filled optional field $ROOT->energy successfully.\n\
[INFO] Filler filled optional field $ROOT->segments->0->pA->x successfully.\n\
...
TEST(templated_filler, fill_optional_scalar_test_case_3) {
    std::string correct_log = "\
[INFO] Filler filled optional field $ROOT->method successfully.\n\
[INFO] Filler filled optional field $ROOT->energy successfully.\n\
";
...
TEST(templated_filler, fill_optional_scalar_test_case_4) {
    std::string correct_log = "\
[INFO] Filler filled optional field $ROOT->method successfully.\n\
[INFO] Filler filled optional field $ROOT->energy successfully.\n\
[INFO] Filler filled optional field $ROOT->segments->0->pA->x successfully.\n\
...
TEST(templated_filler, fill_optional_scalar_test_case_5) {
    std::string correct_log = "\
[INFO] Filler filled optional field $ROOT->method successfully.\n\
[INFO] Filler filled optional field $ROOT->energy successfully.\n\
[INFO] Filler filled optional field $ROOT->segments->0->pA->x successfully.\n\
...
TEST(templated_filler, fill_optional_scalar_test_case_6) {
    std::string correct_log = "\
[INFO] Filler filled optional field $ROOT->method successfully.\n\
[INFO] Filler filled optional field $ROOT->energy successfully.\n\
[INFO] Filler filled optional field $ROOT->segments->0->pA->x successfully.\n\
...
TEST(templated_filler, fill_optional_scalar_test_case_7) {
    std::string correct_log = "\
[INFO] Filler filled optional field $ROOT->method successfully.\n\
[INFO] Filler filled optional field $ROOT->energy successfully.\n\
[INFO] Filler filled optional field $ROOT->segments->0->pA->x successfully.\n\
...
[PROBLEM] The yaml::node $ROOT->segments->0->pB->y is not a scalar.\n\
";
