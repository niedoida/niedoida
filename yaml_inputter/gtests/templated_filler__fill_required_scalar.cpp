...
void parseparse_fill_required_scalar(const YAML::Node& root,
        InpudData& id,
...
TEST(templated_filler, fill_required_scalar_test_case_0) {
...
";
    ...
    InpudData id;
    ASSERT_NO_THROW(parseparse_fill_required_scalar(root, id, log_stream, logerr_stream));
...
TEST(templated_filler, fill_required_scalar_test_case_1) {
    std::string correct_log = "\
[INFO] Filler filled required field $ROOT->method successfully.\n\
[INFO] Filler filled required field $ROOT->energy successfully.\n\
";
...
";
    ...
    std::ostringstream log_stream, logerr_stream;
    InpudData id;
    ASSERT_THROW(parseparse_fill_required_scalar(root, id, log_stream, logerr_stream), std::runtime_error);
    EXPECT_EQ(id.method, 2);
    EXPECT_EQ(id.energy, 5.6);
    EXPECT_EQ(log_stream.str(), correct_log);
    EXPECT_EQ(logerr_stream.str(), correct_logerr);
...
TEST(templated_filler, fill_required_scalar_test_case_2) {
    std::string correct_log = "\
[INFO] Filler filled required field $ROOT->method successfully.\n\
[INFO] Filler filled required field $ROOT->energy successfully.\n\
[INFO] Filler filled required field $ROOT->segments->0->pA->x successfully.\n\
...
TEST(templated_filler, fill_required_scalar_test_case_3) {
    std::string correct_log = "\
[INFO] Filler filled required field $ROOT->method successfully.\n\
[INFO] Filler filled required field $ROOT->energy successfully.\n\
";
...
TEST(templated_filler, fill_required_scalar_test_case_4) {
    std::string correct_log = "\
[INFO] Filler filled required field $ROOT->method successfully.\n\
[INFO] Filler filled required field $ROOT->energy successfully.\n\
[INFO] Filler filled required field $ROOT->segments->0->pA->x successfully.\n\
...
TEST(templated_filler, fill_required_scalar_test_case_5) {
    std::string correct_log = "\
[INFO] Filler filled required field $ROOT->method successfully.\n\
[INFO] Filler filled required field $ROOT->energy successfully.\n\
[INFO] Filler filled required field $ROOT->segments->0->pA->x successfully.\n\
...
TEST(templated_filler, fill_required_scalar_test_case_6) {
    std::string correct_log = "\
[INFO] Filler filled required field $ROOT->method successfully.\n\
[INFO] Filler filled required field $ROOT->energy successfully.\n\
[INFO] Filler filled required field $ROOT->segments->0->pA->x successfully.\n\
...
TEST(templated_filler, fill_required_scalar_test_case_7) {
    std::string correct_log = "\
[INFO] Filler filled required field $ROOT->method successfully.\n\
[INFO] Filler filled required field $ROOT->energy successfully.\n\
[INFO] Filler filled required field $ROOT->segments->0->pA->x successfully.\n\
